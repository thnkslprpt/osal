...
const UT_EntryKey_t UT_StubKey_GenericSemTake = UT_KEY(OS_Rtems_GenericSemTake);
const UT_EntryKey_t UT_StubKey_GenericSemGive = UT_KEY(OS_Rtems_GenericSemGive);
